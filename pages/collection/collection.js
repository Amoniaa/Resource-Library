...
Page({
  ...
  delete: function (e) {
    ...
    var that = this
    wx.request({
      url: getApp().globalData.server + '/srclib/index.php/Home/Resource/delete_collection',
      data: {
  ...
  onShow: function () {
    ...
    wx.request({
      url: getApp().globalData.server + '/srclib/index.php/Home/Resource/get_one_user_all_collections',
      data: {
